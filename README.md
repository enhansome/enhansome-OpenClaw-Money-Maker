...
> A curated list of open-source tools and repos for making money with AI agents like [OpenClaw](https://github.com/openclaw/openclaw) ⭐ 388,588 | 🐛 6,081 | 🌐 TypeScript | 📅 2026-09-02.
...
1. **OpenClaw uses [ClawRouter](https://github.com/BlockRunAI/ClawRouter) ⭐ 6,576 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-02** to access <!-- br:models.chatVisible -->76<!-- /br:models.chatVisible --> LLMs
2. **[Franklin](https://github.com/BlockRunAI/franklin) ⭐ 552 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-02 — the AI agent with a wallet** — runs marketing campaigns, trading signals, and content generation autonomously
...
**Get started:** [Franklin](https://github.com/BlockRunAI/franklin) ⭐ 552 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-02 ⭐ | [ClawRouter v0.12.256](https://github.com/BlockRunAI/ClawRouter) ⭐ 6,576 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-02 ⭐ 6.6k | [BlockRun.ai](https://blockrun.ai)
...
* 🏠 [GitHub](https://github.com/BlockRunAI/franklin) ⭐ 552 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-02 — Source code
...
* [**Freqtrade**](https://github.com/freqtrade/freqtrade) ⭐ 53,942 | 🐛 32 | 🌐 Python | 📅 2026-09-02 ⭐ 53.8k - Free, open-source crypto trading bot. Supports all major exchanges (Binance, Hyperliquid, etc.). ML strategy optimization via FreqAI. Telegram control + WebUI.
  * 💰 **Monetize:** Sell custom strategies, run managed bot services, offer backtesting consulting

* [**Hummingbot**](https://github.com/hummingbot/hummingbot) ⭐ 19,756 | 🐛 155 | 🌐 Python | 📅 2026-09-02 ⭐ 19.7k - Open source market making and liquidity mining bot. Supports 40+ CEXs/DEXs. Customizable strategies in Python.
  * 💰 **Monetize:** Market making profits, liquidity mining rewards, strategy consulting

* [**FinRL**](https://github.com/AI4Finance-Foundation/FinRL) ⭐ 16,198 | 🐛 310 | 🌐 Jupyter Notebook | 📅 2026-07-13 ⭐ 16.2k - Deep reinforcement learning for trading. Supports DQN, DDPG, A2C, SAC, PPO, TD3. Crypto environments with Binance API.
  * 💰 **Monetize:** Sell trained models, quant consulting, proprietary strategy development

* [**Jesse**](https://github.com/jesse-ai/jesse) ⭐ 8,405 | 🐛 16 | 🌐 Python | 📅 2026-08-27 ⭐ 8.4k - Advanced crypto trading bot in Python. Backtesting, paper trading, live trading. Built for algo traders.
  * 💰 **Monetize:** Sell strategies, subscription bot service, algo trading education

* [**OctoBot**](https://github.com/Drakkar-Software/OctoBot) ⭐ 6,505 | 🐛 165 | 🌐 Python | 📅 2026-09-02 ⭐ 6.5k - Open-source bot with AI, Grid, DCA, TradingView strategies. Simple interface, 15+ exchanges.
  * 💰 **Monetize:** Premium strategies, hosting service, configuration consulting

* [**Superalgos**](https://github.com/Superalgos/Superalgos) ⭐ 5,637 | 🐛 113 | 🌐 JavaScript | 📅 2026-09-02 ⭐ 5.6k - Visual crypto trading bot builder. Drag-and-drop strategy design, backtesting, paper trading, multi-server deployments.
...
* [**TradingAgents**](https://github.com/TauricResearch/TradingAgents) ⭐ 102,261 | 🐛 357 | 🌐 Python | 📅 2026-09-01 - Multi-agent trading framework with specialized analyst, researcher, and trader agents.
  * 💰 **Monetize:** Enterprise trading solutions, custom agent development

* [**OpenBB**](https://github.com/OpenBB-finance/OpenBB) ⭐ 72,598 | 🐛 111 | 🌐 Python | 📅 2026-07-30 ⭐ 72.5k - Financial data platform for analysts, quants and AI agents. Open-source investment research terminal with AI copilot.
  * 💰 **Monetize:** Custom research tools, financial data SaaS, enterprise integrations, quant consulting

* [**Dexter**](https://github.com/virattt/dexter) ⭐ 27,563 | 🐛 99 | 🌐 TypeScript | 📅 2026-08-04 ⭐ 27.6k - Autonomous agent for deep financial research. AI-powered analysis and investment insights.
  * 💰 **Monetize:** Research-as-a-service, premium analysis reports, enterprise financial intelligence

* [**OpenAlice**](https://github.com/TraderAlice/OpenAlice) ⭐ 6,912 | 🐛 49 | 🌐 TypeScript | 📅 2026-09-02 ⭐ 6.9k - File-driven AI trading agent engine for crypto and securities markets. Autonomous 24/7 operation.
  * 💰 **Monetize:** Managed trading service, agent customization, strategy licensing

* [**GOAT SDK**](https://github.com/goat-sdk/goat) ⭐ 1,007 | 🐛 69 | 🌐 TypeScript | 📅 2026-07-02 ⭐ 1k - The leading agentic finance toolkit for AI agents. Connect agents to DeFi protocols, wallets, and on-chain actions.
...
* [**pmxt**](https://github.com/pmxt-dev/pmxt) ⭐ 2,113 | 🐛 1,213 | 🌐 TypeScript | 📅 2026-07-18 ⭐ 2.1k - Unified API for trading across prediction markets (Polymarket, Kalshi, etc.).
  * 💰 **Monetize:** Cross-platform arbitrage, multi-market bots, API service

* [**poly-maker**](https://github.com/warproxxx/poly-maker) ⭐ 1,479 | 🐛 4 | 🌐 Python | 📅 2026-07-09 ⭐ 1.5k - Market making bot for Polymarket. Configurable via Google Sheets. Provides liquidity on both sides of the book.
...
* [**PolymarketBTC15mAssistant**](https://github.com/FrondEnt/PolymarketBTC15mAssistant) ⭐ 1,053 | 🐛 7 | 🌐 JavaScript | 📅 2026-01-29 ⭐ 1k - Real-time Polymarket BTC 15m trading assistant for every trader.
...
* [**Prediction Markets Trading Bot Toolkits**](https://github.com/HarrierOnChain/Prediction-Markets-Trading-Bot-Toolkits) ⭐ 430 | 🐛 1 | 🌐 Rust | 📅 2026-08-07 ⭐ 427 - Production-grade Rust bots for Polymarket, Kalshi, and Limitless. 10 strategies on one execution core.
...
* [**Awesome-Prediction-Market-Tools**](https://github.com/aarora4/Awesome-Prediction-Market-Tools) ⭐ 724 | 🐛 126 | 📅 2026-06-30 - Curated list including YN Signals (24/7 alpha aggregator) and Eventarb (free arb alerts).
...
* [**BankrBot Skills**](https://github.com/BankrBot/skills) ⭐ 1,190 | 🐛 325 | 🌐 JavaScript | 📅 2026-08-31 - OpenClaw skills for Polymarket betting, crypto trading, DeFi operations, leverage trading, portfolio management. Multi-chain: Base, Ethereum, Polygon, Solana.
...
* [**OpenOutreach**](https://github.com/eracle/OpenOutreach) ⭐ 2,880 | 🐛 0 | 🌐 Python | 📅 2026-09-01 ⭐ 2.9k - LinkedIn automation: visit profiles, connect, message with AI.
...
* [**ScrapeGraphAI**](https://github.com/ScrapeGraphAI/Scrapegraph-ai) ⭐ 30,371 | 🐛 14 | 🌐 Python | 📅 2026-08-27 ⭐ 30.1k - Python scraper based on AI. Uses LLMs to understand and extract structured data from any website.
  * 💰 **Monetize:** Intelligent scraping SaaS, data extraction services, lead enrichment platform

* [**Google-Maps-Scraper**](https://github.com/omkarcloud/google-maps-scraper) ⭐ 3,403 | 🐛 5 | 📅 2026-07-27 ⭐ 3.2k - Bulk scrape Google Maps (names, addresses, phones, emails, ratings).
  * 💰 **Monetize:** Sell local business leads, B2B contact databases

* [**ChatGPT Scraper**](https://github.com/oxylabs/chatgpt-scraper) ⭐ 3,365 | 🐛 0 | 🌐 Java | 📅 2026-08-26 ⭐ 3.3k - Collect ChatGPT responses via Web Scraper API. Automated prompt responses.
  * 💰 **Monetize:** AI response aggregation, research automation, data collection service

* [**SalesGPT**](https://github.com/filip-michalsky/SalesGPT) ⭐ 2,747 | 🐛 59 | 🌐 HTML | 📅 2024-09-17 ⭐ 2.7k+ - Context-aware AI sales agent for voice, email, SMS. Autonomous across sales funnel stages.
...
* [**MoneyPrinterTurbo**](https://github.com/harry0703/MoneyPrinterTurbo) ⭐ 119,681 | 🐛 17 | 🌐 Python | 📅 2026-09-02 ⭐ 119k - AI one-click HD short video generation.
  * 💰 **Monetize:** YouTube/TikTok monetization, affiliate marketing, video ads

* [**MoneyPrinterV2**](https://github.com/FujiwaraChoki/MoneyPrinterV2) ⭐ 31,738 | 🐛 93 | 🌐 Python | 📅 2026-06-14 ⭐ 31.7k - Automate the process of making money online. Full automation pipeline for content creation and publishing.
  * 💰 **Monetize:** Faceless channels, automated content farms, video-as-a-service

* [**CogVideo**](https://github.com/zai-org/CogVideo) ⭐ 12,992 | 🐛 117 | 🌐 Python | 📅 2025-11-04 ⭐ 13k - Text/image to video generation.
  * 💰 **Monetize:** Content creation, ads, social media, video SaaS

* [**gpt-image2-ppt-skills**](https://github.com/JuneYaooo/gpt-image2-ppt-skills) ⭐ 1,233 | 🐛 2 | 🌐 Python | 📅 2026-08-22 ⭐ 1.2k - Clone any .pptx layout with GPT Image 2 and drop in your own content. 10 bundled styles, OpenClaw/Claude Code skill.
...
* [**YumCut**](https://github.com/IgorShadurin/app.yumcut.com) ⭐ 868 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-26 ⭐ 865 - Free AI video generator for TikTok, Reels, YouTube Shorts. Auto script, scenes, voiceover, subtitles. Multi-language.
...
* [**youtube-automation-agent**](https://github.com/darkzOGx/youtube-automation-agent) ⭐ 3,059 | 🐛 10 | 🌐 JavaScript | 📅 2026-08-25 ⭐ 2.9k - Fully automated YouTube channel with AI agents. Creates, optimizes, publishes 24/7. Works with free Gemini API.
  * 💰 **Monetize:** Ad revenue, affiliate marketing, brand deals

* [**gemini-youtube-automation**](https://github.com/ChaitanyaEswarRajeshJakki/gemini-youtube-automation) ⭐ 336 | 🐛 0 | 🌐 Python | 📅 2026-09-01 ⭐ 332 - Fully autonomous AI pipeline using Gemini to generate and upload educational videos to YouTube.
  * 💰 **Monetize:** Educational channel monetization, faceless channels, course promotion

### Social Media Automation

* [**ALwrity**](https://github.com/ALwrity/ALwrity) ⭐ 1,153 | 🐛 116 | 🌐 Python | 📅 2026-09-01 - AI Digital Marketing Platform with RAG, SEO, multilingual. Blog Writer (Research→Outline→Content→SEO→Publish).
...
* [**LangChain**](https://github.com/langchain-ai/langchain) ⭐ 145,491 | 🐛 440 | 🌐 Python | 📅 2026-09-02 ⭐ 145k - Framework for context-aware reasoning applications.
  * 💰 **Monetize:** LLM apps with monetized endpoints, consulting, templates

* [**Awesome LLM Apps**](https://github.com/Shubhamsaboo/awesome-llm-apps) ⭐ 135,704 | 🐛 5 | 🌐 Python | 📅 2026-08-31 ⭐ 135k - Collection of awesome LLM apps with AI Agents and RAG using OpenAI, Anthropic, Gemini, and open-source models.
  * 💰 **Monetize:** Clone and customize apps, build SaaS products, consulting services

* [**Gemini CLI**](https://github.com/google-gemini/gemini-cli) ⭐ 106,761 | 🐛 856 | 🌐 TypeScript | 📅 2026-09-02 ⭐ 107k - Google's open-source AI agent that brings the power of Gemini directly into your terminal.
  * 💰 **Monetize:** Automation scripts, developer tools, enterprise integrations

* [**AI Agents for Beginners**](https://github.com/microsoft/ai-agents-for-beginners) ⭐ 73,736 | 🐛 12 | 🌐 Jupyter Notebook | 📅 2026-08-27 ⭐ 73.5k - Microsoft's 12 lessons to get started building AI agents. Comprehensive curriculum.
  * 💰 **Monetize:** Training courses, bootcamps, enterprise workshops

* [**MetaGPT**](https://github.com/FoundationAgents/MetaGPT) ⭐ 70,169 | 🐛 132 | 🌐 Python | 📅 2026-01-21 ⭐ 70.1k - The Multi-Agent Framework: First AI Software Company. Assigns roles to agents (Product Manager, Architect, Engineer).
  * 💰 **Monetize:** AI software development agency, code generation SaaS, enterprise consulting

* [**Open Interpreter**](https://github.com/openinterpreter/openinterpreter) ⭐ 68,219 | 🐛 10 | 🌐 Rust | 📅 2026-08-20 ⭐ 68.2k - A natural language interface for computers. Run code, control your computer with plain English.
  * 💰 **Monetize:** Automation services, enterprise deployments, managed computer-use agents

* [**Anything LLM**](https://github.com/Mintplex-Labs/anything-llm) ⭐ 65,504 | 🐛 317 | 🌐 JavaScript | 📅 2026-09-02 ⭐ 65.4k - All-in-one Desktop & Docker AI application with built-in RAG, AI agents, no-code agent builder, MCP compatibility.
  * 💰 **Monetize:** Custom deployments, enterprise hosting, white-label platform

* [**Warp**](https://github.com/warpdotdev/Warp) ⭐ 64,722 | 🐛 5,149 | 🌐 Rust | 📅 2026-09-02 ⭐ 64.7k - The agentic development environment, built for coding with multiple AI agents.
  * 💰 **Monetize:** Developer tool licensing, enterprise features, custom integrations

* [**Mem0**](https://github.com/mem0ai/mem0) ⭐ 64,565 | 🐛 719 | 🌐 Python | 📅 2026-09-01 ⭐ 64.4k - Universal memory layer for AI Agents. Persistent memory across sessions.
  * 💰 **Monetize:** Memory-as-a-service, enterprise integrations, custom implementations

* [**Microsoft Autogen**](https://github.com/microsoft/autogen) ⭐ 60,755 | 🐛 1,030 | 🌐 Python | 📅 2026-04-15 ⭐ 60.7k - A programming framework for agentic AI. Multi-agent conversations, tool use, code execution.
  * 💰 **Monetize:** Enterprise agent solutions, consulting, custom multi-agent systems

* [**CrewAI**](https://github.com/crewAIInc/crewAI) ⭐ 57,987 | 🐛 769 | 🌐 Python | 📅 2026-09-02 ⭐ 57.8k - Lean, fast Python framework for orchestrating role-playing AI agents with collaborative intelligence.
...
* [**Block Goose**](https://github.com/aaif-goose/goose) ⭐ 53,828 | 🐛 264 | 🌐 Rust | 📅 2026-09-02 ⭐ 53.7k - Open source, extensible AI agent that goes beyond code suggestions - install, execute, edit, and test with any LLM.
  * 💰 **Monetize:** Development automation, custom extensions, enterprise licensing

* [**LlamaIndex**](https://github.com/run-llama/llama_index) ⭐ 51,976 | 🐛 685 | 🌐 Python | 📅 2026-09-01 ⭐ 51.9k - Data-centric agents with RAG primitives. 500+ connectors via LlamaHub.
  * 💰 **Monetize:** Data-powered AI agents, specialized apps, consulting

* [**Cherry Studio**](https://github.com/CherryHQ/cherry-studio) ⭐ 51,362 | 🐛 1,488 | 🌐 TypeScript | 📅 2026-09-02 ⭐ 51.3k - AI productivity studio with smart chat, autonomous agents, and 300+ assistants. Unified access to frontier LLMs.
  * 💰 **Monetize:** White-label AI productivity platform, enterprise deployments, custom assistant development

* [**HKUDS/nanobot**](https://github.com/HKUDS/nanobot) ⭐ 47,643 | 🐛 758 | 🌐 Python | 📅 2026-09-02 ⭐ 47.5k - Ultra-Lightweight OpenClaw. Minimal footprint, full capability — ideal for edge deployments.
  * 💰 **Monetize:** Embedded agent services, IoT automation, lightweight enterprise deployments

* [**ToolJet**](https://github.com/ToolJet/ToolJet) ⭐ 40,810 | 🐛 1,187 | 🌐 JavaScript | 📅 2026-09-02 ⭐ 40.8k - Open-source foundation of ToolJet AI - AI-native platform for building internal tools, dashboards, workflows and AI agents.
  * 💰 **Monetize:** Internal tool development, enterprise licensing, custom integrations

* [**UI-TARS Desktop**](https://github.com/bytedance/UI-TARS-desktop) ⭐ 38,793 | 🐛 432 | 🌐 TypeScript | 📅 2026-08-05 ⭐ 38.8k - ByteDance's open-source multimodal AI agent stack connecting AI models and agent infra.
...
* [**iOfficeAI/AionUi**](https://github.com/iOfficeAI/AionUi) ⭐ 32,503 | 🐛 870 | 🌐 TypeScript | 📅 2026-09-02 ⭐ 32.4k - Free, local, open-source 24/7 cowork app and OpenClaw for Gemini CLI, Claude Code.
  * 💰 **Monetize:** Desktop agent licensing, enterprise 24/7 workflow automation

* [**nanoclaw**](https://github.com/nanocoai/nanoclaw) ⭐ 30,681 | 🐛 1,076 | 🌐 TypeScript | 📅 2026-09-02 ⭐ 30.7k - Lightweight alternative to OpenClaw that runs in containers for security and scalability.
  * 💰 **Monetize:** Container-native agent services, multi-tenant deployments, self-hosted SaaS

* [**Graphiti**](https://github.com/getzep/graphiti) ⭐ 30,519 | 🐛 477 | 🌐 Python | 📅 2026-09-01 ⭐ 30.4k - Build real-time knowledge graphs for AI agents. Persistent structured memory.
  * 💰 **Monetize:** Knowledge graph services, enterprise memory solutions, consulting

* [**Jobs Applier AI Agent (AIHawk)**](https://github.com/feder-cr/Jobs_Applier_AI_Agent_AIHawk) ⭐ 30,300 | 🐛 22 | 📅 2026-09-01 ⭐ 30.3k - AI agent that automates job hunt by applying to multiple jobs in a tailored way.
  * 💰 **Monetize:** Job application service, subscription platform, career coaching integration

* [**Composio**](https://github.com/ComposioHQ/composio) ⭐ 30,012 | 🐛 83 | 🌐 TypeScript | 📅 2026-09-02 ⭐ 30k - Equips AI agents & LLMs with 100+ high-quality integrations via function calling.
  * 💰 **Monetize:** Integration platform, custom connectors, enterprise licensing

* [**Sim Studio**](https://github.com/simstudioai/sim) ⭐ 29,514 | 🐛 291 | 🌐 TypeScript | 📅 2026-09-02 ⭐ 29.5k - Open-source platform to build and deploy AI agent workflows.
  * 💰 **Monetize:** Workflow templates, managed hosting, enterprise solutions

* [**OpenAI Agents Python**](https://github.com/openai/openai-agents-python) ⭐ 29,134 | 🐛 62 | 🌐 Python | 📅 2026-09-02 ⭐ 29.1k - OpenAI's lightweight, powerful framework for multi-agent workflows.
  * 💰 **Monetize:** Multi-agent SaaS products, enterprise agent orchestration, consulting

* [**smolagents**](https://github.com/huggingface/smolagents) ⭐ 29,117 | 🐛 757 | 🌐 Python | 📅 2026-08-25 ⭐ 29.1k - HuggingFace's barebones library for agents that think in code. Simple, hackable, powerful.
  * 💰 **Monetize:** Custom coding agents, agent templates, enterprise integrations

* [**Qwen Code**](https://github.com/QwenLM/qwen-code) ⭐ 27,575 | 🐛 1,265 | 🌐 TypeScript | 📅 2026-09-02 ⭐ 27.5k - Open-source AI agent that lives in your terminal, powered by Qwen.
  * 💰 **Monetize:** Developer automation, enterprise licensing, custom extensions

* [**AgenticSeek**](https://github.com/Fosowl/agenticSeek) ⭐ 27,109 | 🐛 34 | 🌐 Python | 📅 2026-08-11 ⭐ 27.1k - Fully local autonomous agent. No APIs, no subscriptions. Thinks, browses the web, and codes locally.
...
* [**Activepieces**](https://github.com/activepieces/activepieces) ⭐ 24,185 | 🐛 518 | 🌐 TypeScript | 📅 2026-09-02 ⭐ 24.1k - AI Agents & MCPs & AI Workflow Automation with \~400 MCP servers for AI agents.
  * 💰 **Monetize:** Workflow marketplace, managed hosting, enterprise integrations

* [**GenAI Agents**](https://github.com/NirDiamant/GenAI_Agents) ⭐ 24,100 | 🐛 15 | 🌐 Jupyter Notebook | 📅 2026-09-02 ⭐ 24k - In-depth tutorials and implementations for various Generative AI Agent techniques.
  * 💰 **Monetize:** Training courses, enterprise workshops, consulting

* [**Coze Studio**](https://github.com/coze-dev/coze-studio) ⭐ 21,532 | 🐛 566 | 🌐 TypeScript | 📅 2026-07-29 ⭐ 21.5k - AI agent development platform with all-in-one visual tools for creation, debugging, and deployment.
  * 💰 **Monetize:** Agent marketplace, managed platform, enterprise features

* [**Suna (Kortix)**](https://github.com/kortix-ai/suna) ⭐ 20,167 | 🐛 57 | 🌐 TypeScript | 📅 2026-09-02 ⭐ 20.2k - Build, manage and train AI Agents with Kortix platform.
  * 💰 **Monetize:** Agent training services, managed platform, enterprise licensing

* [**DB-GPT**](https://github.com/eosphoros-ai/DB-GPT) ⭐ 19,842 | 🐛 428 | 🌐 Python | 📅 2026-08-31 ⭐ 19.8k - AI Native Data App Development framework with Agentic Workflow Expression Language (AWEL) and Agents.
  * 💰 **Monetize:** Data-powered AI apps, enterprise data agents, analytics automation

* [**Pydantic-AI**](https://github.com/pydantic/pydantic-ai) ⭐ 19,663 | 🐛 787 | 🌐 Python | 📅 2026-09-02 - GenAI Agent Framework with validation layer for OpenAI, Anthropic, Google SDKs.
  * 💰 **Monetize:** Validated agent applications, development services

* [**Eliza**](https://github.com/elizaOS/eliza) ⭐ 19,227 | 🐛 1,618 | 🌐 TypeScript | 📅 2026-09-02 ⭐ 19.2k - Autonomous agents for everyone. Popular framework for crypto/social media agents. Multi-platform (Discord, Twitter, Telegram).
...
* [**Qwen-Agent**](https://github.com/QwenLM/Qwen-Agent) ⭐ 17,054 | 🐛 532 | 🌐 Python | 📅 2026-03-04 ⭐ 17k - Agent framework built on Qwen. Features Function Calling, MCP, Code Interpreter, RAG, Chrome extension.
  * 💰 **Monetize:** Qwen-powered apps, MCP integrations, browser extensions

* [**Plandex**](https://github.com/plandex-ai/plandex) ⭐ 15,614 | 🐛 62 | 🌐 Go | 📅 2025-10-03 ⭐ 15.6k - Open source AI coding agent designed for large projects and real world tasks.
  * 💰 **Monetize:** Enterprise coding automation, development agency, managed coding agents

* [**NevaMind-AI/memU**](https://github.com/NevaMind-AI/memU) ⭐ 14,371 | 🐛 117 | 🌐 Python | 📅 2026-09-02 ⭐ 14.4k - Memory layer for 24/7 proactive agents (OpenClaw, Moltbot, Clawdbot). Long-term context across sessions.
...
* [**Microsoft Agent Framework**](https://github.com/microsoft/agent-framework) ⭐ 13,290 | 🐛 648 | 🌐 Python | 📅 2026-09-02 ⭐ 13.2k - Framework for building, orchestrating and deploying AI agents and multi-agent workflows (Python and .NET).
  * 💰 **Monetize:** Enterprise agent solutions, .NET/Python agent development, consulting

* [**VoltAgent**](https://github.com/VoltAgent/voltagent) ⭐ 10,521 | 🐛 80 | 🌐 TypeScript | 📅 2026-08-27 ⭐ 10.5k - AI Agent Engineering Platform built on TypeScript. Production-ready agent orchestration.
  * 💰 **Monetize:** Agent templates, platform licensing, consulting services

* [**Omnigent**](https://github.com/omnigent-ai/omnigent) ⭐ 9,611 | 🐛 1,193 | 🌐 Python | 📅 2026-09-02 ⭐ 9.5k - Open-source agent framework and meta-harness. Orchestrate Claude Code, Codex, Cursor, and custom agents behind one policy + sandbox layer.
  * 💰 **Monetize:** Multi-harness agent platform, managed agent ops, enterprise policy consulting

* [**PraisonAI**](https://github.com/MervinPraison/PraisonAI) ⭐ 9,002 | 🐛 66 | 🌐 Python | 📅 2026-09-02 ⭐ 9k - Production-ready Multi AI Agents framework. Low-code solution for building and managing multi-agent LLM systems.
...
* [**AgentOps**](https://github.com/AgentOps-AI/agentops) ⭐ 5,807 | 🐛 176 | 🌐 Python | 📅 2026-06-25 ⭐ 5.8k - Python SDK for AI agent monitoring, LLM cost tracking, benchmarking. Integrates with CrewAI, Langchain, Autogen.
...
* [**Aeon**](https://github.com/aeonfun/aeon) ⭐ 713 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-01 ⭐ 707 - Autonomous agents that run unattended on GitHub Actions with self-healing skills. Drives Claude Code, Grok, and Codex.
  * 💰 **Monetize:** Always-on automation service, CI-hosted agent products, zero-ops agent hosting

* [**Franklin**](https://github.com/BlockRunAI/franklin) ⭐ 552 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-02 ⭐ FEATURED - The first Autonomous Economic Agent. Natively spends USDC via x402 micropayments to execute real work — marketing campaigns, trading signals, content generation. Smart model routing, self-learning, plugin system.
...
* [**ClawX**](https://github.com/ValueCell-ai/ClawX) ⭐ 7,602 | 🐛 41 | 🌐 TypeScript | 📅 2026-09-02 ⭐ 7.6k - Desktop app GUI for OpenClaw AI agents. Turns CLI-based AI orchestration into a visual desktop experience.
...
* [**clawmetry**](https://github.com/vivekchand/clawmetry) ⭐ 403 | 🐛 159 | 🌐 Python | 📅 2026-09-02 ⭐ 401 - Real-time observability dashboard for OpenClaw agents. See your agent think.
...
* [**browser-use**](https://github.com/browser-use/browser-use) ⭐ 112,035 | 🐛 400 | 🌐 Python | 📅 2026-09-02 ⭐ 112k - Make websites accessible for AI agents. Automate any web task with natural language.
  * 💰 **Monetize:** Web automation services, form filling bots, data extraction, testing automation

* [**Stagehand**](https://github.com/browserbase/stagehand) ⭐ 24,127 | 🐛 343 | 🌐 TypeScript | 📅 2026-09-02 ⭐ 24.1k - The AI Browser Automation Framework. Built on Playwright with AI-powered element selection.
  * 💰 **Monetize:** Web scraping services, testing automation, browser-based RPA

* [**Skyvern**](https://github.com/Skyvern-AI/skyvern) ⭐ 22,910 | 🐛 216 | 🌐 Python | 📅 2026-09-02 ⭐ 22.9k - Automate browser-based workflows with AI. Computer vision + LLM for robust web automation.
...
* [**ShowUI**](https://github.com/showlab/ShowUI) ⭐ 1,895 | 🐛 17 | 🌐 Python | 📅 2026-04-24 ⭐ 1.9k - Vision-Language-Action model for GUI Agent & Computer Use. CVPR 2025 paper implementation.
...
* [**VoltAgent/awesome-openclaw-skills**](https://github.com/VoltAgent/awesome-openclaw-skills) ⭐ 52,321 | 🐛 0 | 📅 2026-09-01 ⭐ 52.3k - Curated collection of OpenClaw skills. 5,400+ skills filtered and categorized.

* [**openclaw/clawhub**](https://github.com/openclaw/clawhub) ⭐ 9,385 | 🐛 52 | 🌐 TypeScript | 📅 2026-09-02 ⭐ 9.4k - Official skill directory and marketplace.
...
* [**LeoYeAI/openclaw-master-skills**](https://github.com/LeoYeAI/openclaw-master-skills) ⭐ 2,129 | 🐛 29 | 🌐 Python | 📅 2026-07-20 ⭐ 2.1k - Curated collection of 1,209+ OpenClaw skills, updated weekly.
...
* [**BankrBot Skills**](https://github.com/BankrBot/skills) ⭐ 1,190 | 🐛 325 | 🌐 JavaScript | 📅 2026-08-31 - Polymarket, crypto trading, DeFi, leverage, portfolio management, NFTs. Multi-chain support.
...
* [**Awesome MCP Servers**](https://github.com/punkpeye/awesome-mcp-servers) ⭐ 93,772 | 🐛 3,686 | 📅 2026-09-01 ⭐ 93.4k - The definitive collection of MCP servers. 500+ servers across all categories.
  * 💰 **Monetize:** Build and list premium MCP servers, consulting for MCP integration

* [**Context7**](https://github.com/upstash/context7) ⭐ 61,500 | 🐛 68 | 🌐 TypeScript | 📅 2026-09-01 ⭐ 61.4k - Up-to-date code documentation MCP server. Gives AI agents current docs instead of stale training data.
  * 💰 **Monetize:** Documentation services, enterprise code intelligence, dev tool integrations

* [**FastMCP**](https://github.com/PrefectHQ/fastmcp) ⭐ 27,484 | 🐛 302 | 🌐 Python | 📅 2026-09-02 ⭐ 27.4k - The fast, Pythonic way to build MCP servers. Production-ready framework for building custom servers.
  * 💰 **Monetize:** Custom MCP server development, consulting, enterprise integrations

* [**MCP-Use**](https://github.com/mcp-use/mcp-use) ⭐ 10,553 | 🐛 53 | 🌐 TypeScript | 📅 2026-09-01 ⭐ 10.5k - Easiest way to interact with MCP servers using custom agents. Agent-first MCP client.
  * 💰 **Monetize:** Agent development services, MCP integration consulting

### Data & APIs

* [**MindsDB**](https://github.com/mindsdb/mindshub) ⭐ 39,679 | 🐛 5 | 🌐 Makefile | 📅 2026-09-02 ⭐ 39.7k - Federated Query Engine for AI. The only MCP Server you'll ever need for database access.
  * 💰 **Monetize:** Data pipeline services, enterprise AI data integration, managed MindsDB hosting

* [**GitHub MCP Server**](https://github.com/github/github-mcp-server) ⭐ 32,665 | 🐛 320 | 🌐 Go | 📅 2026-09-02 ⭐ 32.6k - GitHub's official MCP server. Agents can manage repos, issues, PRs, code search.
  * 💰 **Monetize:** DevOps automation, code review agents, repo management bots

* [**MCP Toolbox**](https://github.com/googleapis/mcp-toolbox) ⭐ 16,297 | 🐛 248 | 🌐 Go | 📅 2026-09-02 ⭐ 16.3k - Google's MCP Toolbox for Databases. Connect AI to PostgreSQL, MySQL, BigQuery, Spanner.
...
* [**blockrun-mcp**](https://github.com/BlockRunAI/blockrun-mcp) ⭐ 393 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-02 ⭐ 393 - Live data for AI agents — search, research, markets, crypto, X/Twitter. Pay-per-call via x402 micropayments. Also available hosted at [`mcp.blockrun.ai`](https://github.com/BlockRunAI/blockrun-mcp-server) (zero install).
...
* [**Playwright MCP**](https://github.com/microsoft/playwright-mcp) ⭐ 36,732 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-01 ⭐ 36.6k - Microsoft's official Playwright MCP server. Full browser automation for AI agents.
  * 💰 **Monetize:** Web scraping services, testing automation, browser-based RPA

* [**Figma Context MCP**](https://github.com/GLips/Figma-Context-MCP) ⭐ 15,762 | 🐛 23 | 🌐 TypeScript | 📅 2026-08-07 ⭐ 15.7k - Provides Figma layout info to AI coding agents. Design-to-code automation.
  * 💰 **Monetize:** Design-to-code services, UI automation, Figma workflow tools

* [**MCP Chrome**](https://github.com/hangwin/mcp-chrome) ⭐ 12,369 | 🐛 226 | 🌐 TypeScript | 📅 2026-01-06 ⭐ 12.4k - Chrome extension MCP server. Browser automation, content analysis, semantic search.
  * 💰 **Monetize:** Chrome automation bots, content extraction, research automation

### Security & Research

* [**Serena**](https://github.com/oraios/serena) ⭐ 28,737 | 🐛 167 | 🌐 Python | 📅 2026-09-01 ⭐ 28.7k - Coding agent toolkit with semantic retrieval and editing. Production-ready code intelligence.
  * 💰 **Monetize:** Code refactoring services, codebase analysis, developer tools

* [**HexStrike AI**](https://github.com/0x4m4/hexstrike-ai) ⭐ 11,499 | 🐛 105 | 🌐 Python | 📅 2026-08-03 ⭐ 11.5k - MCP server with 150+ cybersecurity tools. Automated pentesting, vulnerability discovery, bug bounty automation.
...
* [**GPT Researcher**](https://github.com/assafelovic/gpt-researcher) ⭐ 29,254 | 🐛 67 | 🌐 Python | 📅 2026-08-27 ⭐ 29.2k - Autonomous agent that conducts deep research on any topic. Generates comprehensive reports from multiple sources.
...
* [**500-AI-Agents-Projects**](https://github.com/ashishpatel26/500-AI-Agents-Projects) ⭐ 37,318 | 🐛 64 | 🌐 Python | 📅 2026-07-27 - Curated AI agent use cases across industries (healthcare, finance, education, retail).
...
* [**e2b-dev/awesome-ai-agents**](https://github.com/e2b-dev/awesome-ai-agents) ⭐ 29,795 | 🐛 978 | 📅 2026-08-21 ⭐ 29.8k - Comprehensive list of AI autonomous agents. Well-maintained with categories.
...
* [**mergisi/awesome-openclaw-agents**](https://github.com/mergisi/awesome-openclaw-agents) ⭐ 3,946 | 🐛 88 | 🌐 HTML | 📅 2026-05-25 ⭐ 3.9k - 162 production-ready OpenClaw agent templates with SOUL.md configs across 19 categories.

* [**awesome-ai-agents**](https://github.com/slavakurilyak/awesome-ai-agents) ⭐ 2,193 | 🐛 283 | 🌐 Python | 📅 2025-09-09 - 300+ agentic AI resources.

* [**awesome\_ai\_agents**](https://github.com/jim-schwoebel/awesome_ai_agents) ⭐ 1,961 | 🐛 233 | 📅 2026-03-28 - 1,500+ AI agent resources and tools.

* [**MakeMoneyWithAI**](https://github.com/garylab/MakeMoneyWithAI) ⭐ 895 | 🐛 2 | 🌐 Python | 📅 2026-09-02 - Curated list of open-source AI projects for generating income.
...
* [**BlockRunAI/awesome-blockrun**](https://github.com/BlockRunAI/awesome-blockrun) ⭐ 13 | 🐛 19 | 🌐 JavaScript | 📅 2026-09-02 ⭐ 13 - BlockRun ecosystem hub — docs, SDKs, research, and community. Start here for everything in the x402-native agent stack.

### Infrastructure

* [**ClawRouter v0.12.256**](https://github.com/BlockRunAI/ClawRouter) ⭐ 6,576 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-02 ⭐ 6.6k - Smart LLM router, save <!-- br:savings.autoVsBaselinePct -->84<!-- /br:savings.autoVsBaselinePct -->% on inference. 16-model curated allowlist, one USDC wallet. **Features:** Response caching, 4 routing profiles, `/imagegen`, `clawrouter report`, three-strike escalation, `/debug`, tool-calling filter, session persistence, `clawrouter doctor`, multilingual support.
* [**blockrun-mcp**](https://github.com/BlockRunAI/blockrun-mcp) ⭐ 393 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-02 ⭐ 393 - Live data MCP server for AI agents — search, research, markets, crypto, X/Twitter. Pay-per-call via x402 micropayments.
* **BlockRun SDKs** — OpenAI-compatible, pay-per-call USDC, zero rate limits: [Python](https://github.com/BlockRunAI/blockrun-llm) ⭐ 5 | 🐛 4 | 🌐 Python | 📅 2026-09-02 · [TypeScript](https://github.com/BlockRunAI/blockrun-llm-ts) ⭐ 3 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-02 · [Go](https://github.com/BlockRunAI/blockrun-llm-go) ⭐ 2 | 🐛 4 | 🌐 Go | 📅 2026-09-02 · [XRPL/RLUSD](https://github.com/BlockRunAI/blockrun-llm-xrpl) ⭐ 3 | 🐛 0 | 🌐 Python | 📅 2026-06-26
